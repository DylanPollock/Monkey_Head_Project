...
systemCheck() {
    ...
    checkError "macOS Catalina Check"
...
installHomebrewPackages() {
    ...
    brew update && brew install git node python3 docker
...
installOptionalTools() {
    ...
    brew install postman slack zoom 7zip wget curl terraform kubectl minikube awscli azure-cli
