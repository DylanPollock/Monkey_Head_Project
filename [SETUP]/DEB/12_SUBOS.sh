...
clear
echo -e "\033[0;32m[****|     12_SUBOS.sh - SubOS Setup and Configuration   |****]\033[0m"
echo
...
logError() {
    echo "$(date) - Error: $1 failed with error code $?" >> "$(dirname "$0")/subos_error_log.txt"
}
...
configureSystem() {
    ...
    export SUBOS_ENV_VAR="SubOSValue"
...
echo -e "\033[0;32m[****| SubOS setup and configuration complete! |****]\033[0m"
echo "Logs can be found in $(dirname "$0")/subos_error_log.txt"
