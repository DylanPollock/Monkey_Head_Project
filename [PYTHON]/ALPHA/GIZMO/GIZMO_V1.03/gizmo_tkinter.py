...
class GizmoApp:
    ...
    def create_config_section(self):
        ttk.Label(self.config_frame, text="API Key:").grid(row=0, column=0, sticky="w", padx=5, pady=2)
        self.api_key_var = tk.StringVar(value=self.config['openai']['api_key'])
        self.api_key_entry = ttk.Entry(self.config_frame, textvariable=self.api_key_var)
        ...
        self.temperature_slider = ttk.Scale(self.config_frame, from_=0.0, to_=1.0, variable=self.temperature_var, orient="horizontal")
